...
describe('goodeggs-formatters', function () {
  ...
  it('formatCustomerName', function () {
    ...
    expect(f.formatCustomerName({firstName: '  John  ', lastName: '  Smith  '})).to.eql(
      'John Smith',
    );
  });
  ...
  describe('.formatDateRange', function () {
    ...
    it('formats a date range object', function () {
      ...
      expect(f.formatDateRange(range, clock.pacific.tzid, {separator: ' to '})).to.eql(
  ...
  describe('.formatDate', function () {
    ...
    describe('humanShortDay', () =>
      it('returns abbreviated month and ordinalized day', () =>
        expect(f.formatDate(date, 'humanShortDay', clock.pacific.tzid)).to.eql(
          'Thursday, Mar 8th',
        )));
  ...
  describe('formatLocation', () =>
    it('formats the full address', function () {
      ...
      expect(f.formatLocation(location, 'full')).to.equal(
